    ...
    return (
      <div>
        ...
        <p className="fs-large txt-dark-gray">
          ...
          es propiedad de © Hero MotoCorp. Puede descargar el contenido sólo para uso personal
          ...
          prohibido y Hero MotoCorp tiene todos los derechos reservados.
        </p>
        <p className="fs-large txt-dark-gray">
          Hero MotoCorp hará todo lo posible para incluir la información precisa en el sitio y
          sólo con propósitos generales. Hero MotoCorp no tiene representaciones, garantías o
          seguridad sobre la precisión, difusión o integridad de la información provista.
        </p>
        <p className="fs-large txt-dark-gray">
          La información sobre este sitio no constituye una incitación a invertir en Hero MotoCorp
          y Hero MotoCorp o sus representantantes, agentes empleadores no serán responsables de
