    ...
    return (
      <div>
        ...
        <p className="fs-large txt-dark-gray">
          ...
          es propiedad de Distribuidora Argentina de Motos S.A. Puede descargar el contenido sólo para uso personal
        ...
        <p className="fs-large txt-dark-gray">
          Distribuidora Argentina de Motos S.A. hará todo lo posible para incluir la información precisa en el sitio y
          sólo con propósitos generales. Distribuidora Argentina de Motos S.A. no tiene representaciones, garantías o
          seguridad sobre la precisión, difusión o integridad de la información provista.
        </p>
        <p className="fs-large txt-dark-gray">
          La información sobre este sitio no constituye una incitación a invertir en Distribuidora Argentina de Motos S.A.
          y Distribuidora Argentina de Motos S.A. o sus representantantes, agentes empleadores no serán responsables de
